...
public record TaskRequestDTO(
    ...
    @Size(min = 5, max = 150, message = "Título da task precisa ter entre 5 a 150 carácteres")
    String title,
    ...
    @NotNull(message = "Data limite da task é obrigatória")
    @FutureOrPresent(message = "A data de vencimento da task não pode estar no passado")   
    LocalDate dueDate,
